...
SECRET_KEY = 'iorw-ulkg)_t2*do^1wo58bge-*3^zlk&3jy@^kvyn_@7@k4l%'
...
# Media files (optional image uploads)
MEDIA_URL = '/media/'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/index/'  # or wherever you want to redirect post-login
